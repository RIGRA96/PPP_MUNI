	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> CITA --- Restablecer contraseña del personal</h2></a>
				</div>
...
<i class="fa fa-lock"></i> </span>
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase">SISTEMA DE CITA MEDICA - INGENIERIA DE SISTEMAS</span>. <span>eservados todos los derechos</span>
					</div>
