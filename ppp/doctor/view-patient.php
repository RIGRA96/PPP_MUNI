...
<html lang="en">
	<head>
		<title>Médico --- Administrar personal</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Médico --- Administrar personal</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Médico</span>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Personal</span></h5>
<?php
                               $vid=$_GET['viewid'];
...
<td colspan="4" style="font-size:20px;color:blue">
 Patient Details</td></tr>
    ...
    <tr>
    <th scope>Nombre del personal</th>
    <td><?php  echo $row['PatientName'];?></td>
    <th scope>Correo electrónico del personal</th>
    <td><?php  echo $row['PatientEmail'];?></td>
  </tr>
  <tr>
    <th scope>Número móvil del personal</th>
    <td><?php  echo $row['PatientContno'];?></td>
    <th>Dirección del personal</th>
    <td><?php  echo $row['PatientAdd'];?></td>
  </tr>
    <tr>
    <th>Género del personal</th>
  ...
  <tr>
    ...
    <th>Historial médico del personal (si corresponde)</th>
    <td><?php  echo $row['PatientMedhis'];?></td>
     <th>Fecha de registro del personal</th>
