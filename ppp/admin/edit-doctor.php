...
<html lang="en">
	<head>
		<title>Administrador --- Editar detalles deL Personal</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administrador --- Editar detalles del Personal</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
									...
									<li class="active">
										<span>Editar detalles del Personal</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Editar información del Personal</h5>
												</div>
...
<p><b>Fecha de registro del perfil: </b><?php echo htmlentities($data['creationDate']);?></p>
