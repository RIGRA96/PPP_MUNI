				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administrador --- Panel de control</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Administrar RR.HH</h2>
...
{
?>
											Total del personal:<?php echo htmlentities($num_rows1);  } ?>		
												</a>
...
{
?>
Total de oacientes:<?php echo htmlentities($num_rows);  
} ?>		
</a>
											</p>
										</div>
