...
$_SESSION['msg']="Especialización médica agregada exitosamente !!";
}

if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from doctorSpecilization where id = '".$_GET['id']."'");
                  $_SESSION['msg']="Se elimino correctamente !!";
		  }
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<title>Administrador --- Especialización médica</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Especialización médica</h5>
												</div>
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Ingrese a la especialización médica">
														</div>
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Administrar:      <span class="text-bold"> Especialización médica</span></h5>
